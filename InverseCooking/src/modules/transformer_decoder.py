...
import InverseCooking.src.modules.utils as utils
...
# =============================================================================
        ...
        if ingr_mask is not None:
            ingr_mask = ~(ingr_mask.squeeze(1)).byte
    ...
    def sample(self, ingr_features, ingr_mask, greedy=True, temperature=1.0, beam=-1,
        ...
        for i in range(self.seq_length):
            # forward
            outputs, _ = self.forward(ingr_features, ingr_mask, torch.stack(sampled_ids, 1).to(device),
